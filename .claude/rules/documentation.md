...
This project uses **strict documentation management**. Detailed documentation belongs in `docs/`, with references and brief summaries in `CLAUDE.md`.
...
- **Summaries and references** → `CLAUDE.md` Project Documentation References section
...
After creating a new doc, add a reference entry to `CLAUDE.md`:
```markdown
...
Then reference from `CLAUDE.md` or code with a link.
